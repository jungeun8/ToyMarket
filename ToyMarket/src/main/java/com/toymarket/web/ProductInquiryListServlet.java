...
public class ProductInquiryListServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		List<ProductInquiryDto> inquiryList = productInquiryDao.getInquiryList(param);
		
		// HashMap객체에 추가된 파라미터값으로 게시글 갯수 조회하기
		int totalRows = productInquiryDao.getTotalRows(param);
		// 전체 페이지 갯수 계산하기
		...
		data.put("inquiryList", inquiryList);
